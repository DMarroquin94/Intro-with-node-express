	...
	var tableContent = '';
	 ...
	 $.getJSON( '/customerlist', function( data ) {
	 	...
	 	for (var i = 0; i < data.length; i++) {
            ...
            tableContent += '<td><a href="#' + data[i].id + '" class="linkedituser" rel="' + data[i].username + '">edit</a></td>';
            tableContent += '<td><a href="#' + data[i].id + '" class="linkdeleteuser" rel="' + data[i].username + '">delete</a></td>';
            tableContent += '</tr>';
   	 	}
